...
$lang_adm_boardpasswordhashed = 'Only stored as a hash and cannot be displayed again.';
$lang_adm_boardpasswordset = 'A password is set. It is only stored as a hash and cannot be displayed again. Leave empty to keep it.';
