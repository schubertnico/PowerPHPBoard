...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $login === 1) {
    if (!CSRF::validateFromPost()) {
        $loginerror = $lang_csrfinvalid ?? 'The security token is invalid. Please reload the page and try again.';
...
<div class="row justify-content-center">
  ...
  <?php if ($loginSuccess): ?>
    <div class="card shadow-sm border-success">
      ...
      <div class="card-body">
        <p class="mb-3"><?php echo Security::escape($lang_loginok ?? 'Login successful!'); ?></p>
        ...
        <form action="login.php" method="post" class="needs-validation" novalidate>
          ...
          <div class="mb-3">
            ...
            <div id="emailHelp" class="form-text">
              <?php echo Security::escape($lang_loginemailhelp ?? 'Please enter the email address you registered with.'); ?>
            </div>
            <div class="invalid-feedback">
              <?php echo Security::escape($lang_insertemail ?? 'Please enter your email address'); ?>
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="invalid-feedback">
              <?php echo Security::escape($lang_insertpwd ?? 'Please enter your password'); ?>
            </div>
          </div>
          ...
          <div class="d-flex flex-wrap gap-2 align-items-center">
            ...
            <a class="btn btn-link" href="sendpassword.php?catid=<?php echo (int) $catid; ?>&boardid=<?php echo (int) $boardid; ?>">
              <?php echo Security::escape($lang_pwdforgotten ?? 'Forgot password?'); ?>
            </a>
          </div>

          <p class="form-text mt-3 mb-0">
            <i class="bi bi-info-circle" aria-hidden="true"></i>
            <?php echo Security::escape($lang_cookeisenabled ?? 'Cookies müssen aktiviert sein'); ?>
          </p>
        </form>
      </div>
    </section>
